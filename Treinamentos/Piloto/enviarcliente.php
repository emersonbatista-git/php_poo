...
if (mysqli_num_rows($retorno)>0) {
    ...
    $sql = "INSERT INTO db_fortuna_sys.clientes(nome,endereco,numero,bairro,cidade,estado,pais,email,telefone,cnpj,cep) values('$nome','$endereco','$numero','$bairro','$cidade','$estado','$pais','$email','$telefone','$cnpj', '$cep')";
